...
| `kbvMedicationRequest.medication` | `bfarmMedicationRequest.medication` | Transformiert die Medication-Referenz zu urn:uuid Format<br>→ erstellt neues Reference |
